  ...
  return (
    <nav className="navbar navbar-expand-lg bg-primary">
        <div className="container-fluid">
            <Link to="/characters" className="navbar-brand link-light">Pet Diver<img style={{marginLeft: "10px"}}src='https://i.imgur.com/YC6rhTp.png' alt="Logo" width="50" height="40" class="d-inline-block align-text-top"></img></Link>
