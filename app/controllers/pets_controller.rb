class PetsController < ApplicationController
    ...
    def create
        ...
        UserMailer.with(name: params[:name], type: pet.pet_archetype.name, description: pet.pet_archetype.description, email: pet.character.user.email).pet_welcome_email.deliver_later
